...
const navbar = () => {
  return (
    <>
    <div className="triangle w-240 h-24 rounded-br-6xl bg-gradient-to-br from-orange-500 to-red-600 transform rotate-0"></div>
  ...
  <div
    ...
    style={{
      ...
      background: 'linear-gradient(60deg, #0000 350px, #000 0)',
      WebkitMask: 'var(--mask)',
      mask: 'var(--mask)'
    }}
  ></div>
