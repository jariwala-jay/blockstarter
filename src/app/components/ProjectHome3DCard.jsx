...
const ProjectHome3DCard = () => {
  return (
    <CardContainer className="inter-var">
      <CardBody className="bg-gray-50 relative group/card border-black/[0.1] w-full sm:w-[30rem] h-auto rounded-xl p-4 sm:p-6 border">
        <CardItem
          translateZ="50"
          className="text-md sm:text-xl font-bold text-neutral-600 "
        >
          Crypto Trading App
        </CardItem>
        <CardItem
        ...
        >
          Creating platform for secure and efficient cryptocurrency trading.
        </CardItem>
